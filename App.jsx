// Healthcare Project - Multipage Site (react)
// Rewritten to fix JSX syntax errors, expand page content (essay paragraphs and MLA citations),
// add charts, embeds, bullet lists, and ensure all JSX tags are matched.
